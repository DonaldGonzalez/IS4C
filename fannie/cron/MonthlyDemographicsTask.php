...
class MonthlyDemographicsTask extends FannieTask {

	public $nice_name = 'Update Demographics';
	public $help_info = 'Re-builds some tables to speed up 
		WFC-specific reporting';
...
if (php_sapi_name() === 'cli'){
	$obj = new MonthlyDemographicsTask();	
	$obj->run();
}
