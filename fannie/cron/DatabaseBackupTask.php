...
class DatabaseBackupTask extends FannieTask {

	public $nice_name = 'Backup Database';
	public $help_info = 'Backup MySQL database based
   on configuration settings';

	function run(){
		global $FANNIE_OP_DB, $FANNIE_TRANS_DB, $FANNIE_ARCHIVE_DB,
			$FANNIE_BACKUP_PATH, $FANNIE_BACKUP_NUM,
			$FANNIE_BACKUP_BIN, $FANNIE_SERVER,
