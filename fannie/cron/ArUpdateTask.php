...
class ArUpdateTask extends FannieTask {

	public $nice_name = 'Update AR History';
	public $help_info = 'Copies AR transaction information:
   - trans_subtype=\'MI\'
   - department = 990
   for the previous day from dlog_15 into ar_history.
   ...
   Should be run after dtransaction rotation (nightly.dtrans.php)
   and after midnight.';
	public $scheduling_info = 'Nightly, after midnight and after
		archiving dtransactions';

	public function run(){
		global $FANNIE_AR_DEPARTMENTS, $FANNIE_TRANS_DB;
		set_time_limit(0);
